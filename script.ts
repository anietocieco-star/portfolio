...
const scrollProgressBar = document.getElementById("scrollProgressBar") as HTMLSpanElement | null
...
const sectionsToReveal = Array.from(document.querySelectorAll(".reveal-on-scroll")) as HTMLElement[]
...
const container = document.getElementById("projectsContainer") as HTMLDivElement | null
const filterButtons = Array.from(document.querySelectorAll(".filterBtn")) as HTMLButtonElement[]
...
function setActiveFilter(lang: string) {
...
function renderEmptyState(
  message: string,
  title = "No projects match this stack yet.",
  kicker = "Filtered showcase"
) {
...
function renderProjects(lang: string) {
